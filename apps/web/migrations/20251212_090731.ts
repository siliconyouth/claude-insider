...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_resources_status" AS ENUM('official', 'community', 'beta', 'deprecated', 'archived');
  CREATE TYPE "public"."enum_resources_featured_reason" AS ENUM('editors-pick', 'most-popular', 'new', 'trending', 'essential');
  CREATE TABLE "users" (
  ...
  CREATE TABLE "resources" (
  	...
  	"status" "enum_resources_status" DEFAULT 'community' NOT NULL,
  	...
  	"featured_reason" "enum_resources_featured_reason",
  	"added_date" timestamp(3) with time zone NOT NULL,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_resources_featured_reason";`)
}
