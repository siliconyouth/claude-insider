          ...
          <div className="hidden md:flex items-center gap-0.5">
            ...
            <NavDropdown
              ...
              featured={{
                ...
                href: "/mcp-playground",
                description: "Build, validate, and share MCP server configurations interactively",
                icon: <PlaygroundIcon />,
                badge: "NEW",
              }}
              sections={[
                {
                  title: "Development",
                  items: [
                    { label: "MCP Servers", href: "/resources/mcp-servers", description: "Model Context Protocol servers", icon: <ServerIcon />, badge: "2,136+" },
