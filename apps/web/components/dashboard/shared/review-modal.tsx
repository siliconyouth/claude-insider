        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-800">
          ...
          <button
            ...
            className={cn(
              ...
              isLoading ? "text-gray-600 cursor-not-allowed" : "text-gray-400 hover:text-white hover:bg-gray-800"
            )}
...
export function DetailRow({ label, value, className }: DetailRowProps) {
  return (
    <div className={cn("flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4", className)}>
      <span className="text-sm text-gray-400 sm:w-32 shrink-0">{label}</span>
