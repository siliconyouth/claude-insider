  ...
  return (
    <div className="border-t border-gray-200 dark:border-[#1a1a1a] bg-gradient-to-b from-gray-50 to-white dark:from-[#0a0a0a] dark:to-[#111111]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-xl font-semibold text-center mb-10 ui-text-heading">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
          ...
          <div className="group text-center">
            ...
            <div className="text-sm font-semibold ui-text-heading">Claude Opus 4.5</div>
            <div className="text-xs ui-text-secondary mt-1">AI-Powered</div>
          </div>
          ...
          <div className="group text-center">
            ...
            <div className="text-sm font-semibold ui-text-heading">E2EE Messaging</div>
            <div className="text-xs ui-text-secondary mt-1">Matrix Protocol</div>
          </div>
          ...
          <div className="group text-center">
            ...
            <div className="text-sm font-semibold ui-text-heading">42 AI Voices</div>
            <div className="text-xs ui-text-secondary mt-1">ElevenLabs TTS</div>
          </div>
          ...
          <div className="group text-center">
            ...
            <div className="text-sm font-semibold ui-text-heading">1,952+</div>
            <div className="text-xs ui-text-secondary mt-1">Curated Resources</div>
          </div>
          ...
          <div className="group text-center">
            ...
            <div className="text-sm font-semibold ui-text-heading">Open Source</div>
            <div className="text-xs ui-text-secondary mt-1">MIT License</div>
          </div>
        </div>
      </div>
    </div>
