...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      broken_link_queue: {
        Row: {
          ...
          suggested_url_source: string | null
          updated_at: string
        }
        Insert: {
          created_at?: string
        ...
        Relationships: [
          {
            foreignKeyName: "broken_link_queue_resource_id_fkey"
            columns: ["resource_id"]
            isOneToOne: true
          ...
          {
            foreignKeyName: "broken_link_queue_reviewed_by_fkey"
            columns: ["reviewed_by"]
            isOneToOne: false
            referencedRelation: "mcp_configs_gallery"
            referencedColumns: ["author_id"]
      ...
      mcp_config_reviews: {
        ...
        Relationships: [
          {
            foreignKeyName: "mcp_config_reviews_config_id_fkey"
            columns: ["config_id"]
            isOneToOne: false
          ...
          },
          {
            ...
            columns: ["config_id"]
            isOneToOne: false
            referencedRelation: "mcp_configs_moderation_queue"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "mcp_config_reviews_reviewer_id_fkey"
            columns: ["reviewer_id"]
            isOneToOne: false
            referencedRelation: "mcp_configs_gallery"
            referencedColumns: ["author_id"]
      ...
      mcp_config_stars: {
        ...
        Relationships: [
          {
            foreignKeyName: "mcp_config_stars_config_id_fkey"
            columns: ["config_id"]
            isOneToOne: false
            referencedRelation: "mcp_configs"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "mcp_config_stars_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "mcp_configs_gallery"
            referencedColumns: ["author_id"]
      ...
      mcp_config_versions: {
        ...
        Relationships: [
          {
            foreignKeyName: "mcp_config_versions_config_id_fkey"
            columns: ["config_id"]
            isOneToOne: false
            referencedRelation: "mcp_configs"
            referencedColumns: ["id"]
      ...
      mcp_configs: {
        ...
        Relationships: [
          {
            foreignKeyName: "mcp_configs_forked_from_id_fkey"
      ...
      resource_discovery_queue: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "resource_discovery_queue_source_submission_id_fkey"
            columns: ["source_submission_id"]
            isOneToOne: false
            referencedRelation: "resource_submissions"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      resource_link_validations: {
        ...
        Relationships: [
          {
            foreignKeyName: "resource_link_validations_resource_id_fkey"
            columns: ["resource_id"]
            isOneToOne: true
            referencedRelation: "resources"
            referencedColumns: ["id"]
      ...
      resource_submissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "resource_submissions_reviewed_by_fkey"
            columns: ["reviewed_by"]
            isOneToOne: false
            referencedRelation: "mcp_configs_gallery"
            referencedColumns: ["author_id"]
          ...
          {
            foreignKeyName: "resource_submissions_submitter_user_id_fkey"
    ...
    Functions: {
      ...
      fork_mcp_config: {
        Args: { p_config_id: string; p_name?: string }
        Returns: string
      }
      ...
      moderate_mcp_config: {
        Args: { p_approved: boolean; p_config_id: string; p_feedback?: string }
        Returns: boolean
      }
      queue_ai_operation: {
        Args: {
      ...
      save_mcp_config_version: {
        Args: { p_change_summary?: string; p_config_id: string }
        Returns: number
      }
