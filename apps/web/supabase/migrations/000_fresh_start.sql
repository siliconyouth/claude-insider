...
CREATE TABLE IF NOT EXISTS public.device_keys (
  ...
  device_name TEXT,
  device_type TEXT CHECK (device_type IN ('web', 'mobile', 'desktop', 'server')),
  is_verified BOOLEAN DEFAULT FALSE,
  verified_at TIMESTAMPTZ,
  verified_by_user_id TEXT REFERENCES public."user"(id),
  verified_by_device_id TEXT,
  verification_method TEXT CHECK (verification_method IN ('sas', 'cross_sign', 'admin', 'qr', 'system')),
...
-- =============================================================================
-- SECTION 11: PERFORMANCE OPTIMIZED RPC FUNCTIONS
-- =============================================================================

-- -----------------------------------------------------------------------------
-- 11.1 Get Total Unread DM Count (for unread badge)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 11.2 Get Conversations Optimized (single query instead of 4)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 11.3 Get Messages Paginated (for virtual scrolling)
-- -----------------------------------------------------------------------------
