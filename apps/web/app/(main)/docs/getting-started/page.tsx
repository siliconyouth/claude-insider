...
export default function GettingStartedPage() {
  return (
    ...
    >
      <h2 className="text-2xl font-semibold mt-12 mb-4 text-gray-900 dark:text-white">What is Claude?</h2>
      ...
      <h2 className="text-2xl font-semibold mt-12 mb-4 text-gray-900 dark:text-white">What is Claude Code?</h2>
      <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
      ...
      <h2 className="text-2xl font-semibold mt-12 mb-4 text-gray-900 dark:text-white">Next Steps</h2>
      <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
