            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="animate-fade-in text-left" style={{ contentVisibility: 'visible', containIntrinsicSize: '0 500px' }}>
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-violet-500/10 border border-violet-500/20 text-violet-600 dark:text-violet-400 text-xs font-medium mb-6">
                  ...
                  v1.10.6 • 49 Features • 1,950+ Resources • AI Assistant
                </div>
                ...
                <p className="mt-6 text-xs text-gray-500 dark:text-gray-400">
                  v1.10.6 • Built with Claude Code • Powered by Claude Opus 4.5 • Open Source
                </p>
              </div>
        ...
        <div className="border-t border-gray-200 dark:border-[#1a1a1a] bg-gray-50 dark:bg-[#0a0a0a]">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-8 text-center">
              ...
              <div className="group">
                <div className="text-3xl font-bold gradient-text-stripe group-hover:scale-110 transition-transform">50+</div>
                <div className="text-gray-600 dark:text-gray-400 mt-2 text-sm">
                  Achievements
                </div>
              </div>
              <div className="group">
                <div className="text-3xl font-bold gradient-text-stripe group-hover:scale-110 transition-transform">18</div>
                <div className="text-gray-600 dark:text-gray-400 mt-2 text-sm">
                  Languages
                </div>
              </div>
              <div className="group">
                ...
                <div className="text-gray-600 dark:text-gray-400 mt-2 text-sm">MIT License</div>
              </div>
            </div>
          </div>
        </div>
