    ...
    <div className="min-h-screen">
      ...
      <main id="main-content" className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
        <article className="ui-prose">
          <h1 className="text-4xl font-bold mb-2 ui-text-heading">Privacy Policy</h1>
          ...
          <section className="mb-8">
            ...
            <div className="overflow-x-auto mt-4">
              <table className="min-w-full text-sm ui-text-body">
          ...
          <section className="mb-8">
            ...
            <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-4 mt-4">
              ...
              <ul className="list-disc list-inside space-y-1 ui-text-body text-sm">
          ...
          <section className="mb-8">
            ...
            <p className="ui-text-body leading-relaxed mt-2">
          ...
          <section className="mb-8">
            ...
            <div className="ui-bg-card border ui-border rounded-lg p-4 mt-4">
              <ol className="list-decimal list-inside space-y-2 ui-text-body">
          ...
          <section className="mb-8">
            ...
            <div className="ui-bg-card border ui-border rounded-lg p-4 mt-4">
              <p className="ui-text-body leading-relaxed mb-4">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b ui-border">
                    <th className="text-left py-2 ui-text-body">Cookie</th>
                    <th className="text-left py-2 ui-text-body">Purpose</th>
                    <th className="text-left py-2 ui-text-body">Duration</th>
                  </tr>
                </thead>
