  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Beta Applications</h2>
            ...
            {applications.map((app) => (
              <div
                ...
                className={cn(
                  ...
                  selectedApp?.id === app.id && "bg-gray-50 dark:bg-gray-800/50"
                )}
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-2 line-clamp-2">{app.motivation}</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="sticky top-0 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 p-6 flex items-center justify-between">
              ...
              <button
                onClick={() => setSelectedApp(null)}
                className="p-2 rounded-lg text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800"
              >
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-lg font-medium text-gray-900 dark:text-white">{selectedApp.userName}</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">{selectedApp.userEmail}</p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-gray-900 dark:text-white whitespace-pre-wrap">{selectedApp.motivation}</p>
                </div>

                {selectedApp.experienceLevel && (
                  <div>
                    <label className="text-sm font-medium text-gray-600 dark:text-gray-400">Experience Level</label>
                    <p className="mt-1 text-gray-900 dark:text-white capitalize">{selectedApp.experienceLevel}</p>
                  </div>
                )}
                ...
                {selectedApp.useCase && (
                  <div>
                    ...
                    <p className="mt-1 text-gray-900 dark:text-white whitespace-pre-wrap">{selectedApp.useCase}</p>
                  </div>
                )}
                ...
                {selectedApp.reviewNotes && (
                  <div>
                    <label className="text-sm font-medium text-gray-600 dark:text-gray-400">Previous Review Notes</label>
                    <p className="mt-1 text-gray-900 dark:text-white whitespace-pre-wrap">{selectedApp.reviewNotes}</p>
                  </div>
                )}
              </div>
                ...
                <div className="space-y-4 pt-4 border-t border-gray-200 dark:border-gray-800">
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-2.5 rounded-lg bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                      rows={3}
