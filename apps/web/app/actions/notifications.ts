...
export async function getNotificationPreferences(): Promise<{
  ...
  try {
    ...
    return {
      data: data
        ? {
            in_app_comments: data.in_app_comments,
            in_app_replies: data.in_app_replies,
            in_app_suggestions: data.in_app_suggestions,
            in_app_follows: data.in_app_follows,
            in_app_mentions: data.in_app_mentions,
            email_comments: data.email_comments,
            email_replies: data.email_replies,
            email_suggestions: data.email_suggestions,
            email_follows: data.email_follows,
